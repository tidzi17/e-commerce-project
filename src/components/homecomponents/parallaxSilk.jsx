...
export default function ParallaxSilk() {
  return (
   ...
   <section className=' mb-10'>
    ...
    bgImage={bgImage}
    strength={300} 
    className="brightness-20 w-full h-[40vh] lg:h-[60vh] xl:h-[75vh] rounded-2xl">
        ...
        <a href='/blog' className='w-fit border-[1px] border-white px-4 py-2 text-sm md:text-xl'>Discover</a>
        </div>

  ...
  return (
    ...
    <div className="w-1/2 h-full flex flex-col justify-between rounded-3xl bg-black/10 p-4">
        <div className='mt-7 h-fit'>
            ...
            <p className='text-lg font-junge text-zinc-700'>Dive into our blog for insightful articles, expert tips, and skincare trends. Discover the latest in beauty, wellness, and self-care, crafted to inspire and elevate your skincare journey.</p>
        </div>
            ...
            {articles.slice(0, 2).map((article, i) => (
                <div key={i} className='w-1/2 h-full  gap-1 flex flex-col'>
                    ...
                    <div className='mt-2 left-4'>
                        <p className='font-junge text-xl mb-2'>{article.title}</p>
